...
<template>
    <div class="upload">
        ...
        <div class=resumable-drop v-show="resumable_drop" :class="{'resumable-dragover': resumableDrag}"
        @dragover="resumableDrag=true" @drop="resumableDrag=false" @dragleave="resumableDrag=false"
        >
